...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
        ...
        <div x-data="{ open: false }" class="max-w-screen-xl mx-auto">
            ...
            <div class="relative pt-6 px-4 sm:px-6 lg:px-8">
                ...
                <div class="hidden md:block md:ml-10 md:pr-4">
                    ...
                    <a href="#about" class="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">About</a>
                    <a href="#services" class="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Services</a>
                    <a href="#contact" class="ml-8 font-medium text-gray-500 hover:text-gray-900 transition duration-150 ease-in-out">Contact</a>
                </div>
                </nav>
            </div>
            ...
            class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden">
                ...
                <div class="rounded-lg bg-white shadow-xs overflow-hidden" role="menu" aria-orientation="vertical" aria-labelledby="main-menu">
                    ...
                    <a href="#about" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">About</a>
                    <a href="services" class="mt-1 block px-3 py-2 rounded-md text-base font-medium text-gray-700 hover:text-gray-900 hover:bg-gray-50 focus:outline-none focus:text-gray-900 focus:bg-gray-50 transition duration-150 ease-in-out" role="menuitem">Services</a>
    ...
    <div id="services" class="py-12 bg-gray-100">
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
            <p class="text-base leading-6 text-indigo-600 font-semibold tracking-wide uppercase">Services</p>
            <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
                With proven expertise
            </h3>
            <p class="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
                We craft websites, web applications and provide any kinds of IT support
            </p>
            </div>
            ...
            <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <h4 class="text-lg leading-6 font-medium text-gray-900">Website Design</h4>
                    <p class="mt-2 text-base leading-6 text-gray-500">
                        We desgin business/corporate/company websites with modern technology
                    </p>
                    </div>
                </div>
                </li>
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <h4 class="text-lg leading-6 font-medium text-gray-900">E-Commerce Development</h4>
                    <p class="mt-2 text-base leading-6 text-gray-500">
                        We build exclusive E-Commerce applications with extensive features that attract customers
                    </p>
                    </div>
                </div>
                </li>
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <h4 class="text-lg leading-6 font-medium text-gray-900">Web Application</h4>
                    <p class="mt-2 text-base leading-6 text-gray-500">
                        We craft Tailor-made Web Application that is highly scaleable
                    </p>
                    </div>
                </div>
                </li>
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <h4 class="text-lg leading-6 font-medium text-gray-900">Mobile App</h4>
                    <p class="mt-2 text-base leading-6 text-gray-500">
                        We develop both native and hybrid mobile applications
                    </p>
                    </div>
                </div>
                </li>
    ...
    <div id="contact" class="py-12 bg-white">
        <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="lg:text-center">
            <p class="text-base leading-6 text-indigo-600 font-semibold tracking-wide uppercase">Contact</p>
            <h3 class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl sm:leading-10">
                Let's work together
            </h3>
            <p class="mt-4 max-w-2xl text-xl leading-7 text-gray-500 lg:mx-auto">
                We would love to hear from you! Send us a message or an email
            </p>
            </div>
            ...
            <ul class="md:grid md:grid-cols-2 md:col-gap-8 md:row-gap-10">
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <h4 class="text-lg leading-6 font-medium text-gray-900">Email</h4>
                    <p class="mt-2 text-base leading-6 text-gray-500">
                        hello@faysal.me
                    </p>
                    </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-4">
                    <h4 class="text-lg leading-6 font-medium text-gray-900">Phone</h4>
                    <p class="mt-2 text-base leading-6 text-gray-500">
                        01670347708
                    </p>
                    </div>
